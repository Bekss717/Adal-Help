      ...
      <section className="section about-section">
        <div className="container about-inner">
          <div className="about-text reveal" ref={addReveal}>
            ...
            <p className="about-desc">
              Мошенники эксплуатируют щедрость. Реальные сборы не могут завоевать доверие. Доноры перестают давать — не потому, что не заботятся, а потому, что были обмануты.
            </p>
            <p className="about-desc">
